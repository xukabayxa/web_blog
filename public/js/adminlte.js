...
(function(global, factory) {
                ...
                if (this._config.controlsidebarSlide) {
                    ...
                    $("body")
                        ...
                        .queue(function() {
                            ...
                            $("html").removeClass(
                                ClassName.CONTROL_SIDEBAR_ANIMATE
                            );
                            $(this).dequeue();
                        });
                } else {
        ...
        var Layout = /*#__PURE__*/ (function() {
            ...
            _proto.fixLayoutHeight = function fixLayoutHeight(extra) {
                ...
                if (offset !== false) {
                    ...
                    if (this._isFooterFixed()) {
                        $(Selector.CONTENT).css(
                            "min-height",
                            parseFloat($(Selector.CONTENT).css("min-height")) +
                                heights.footer
                        );
                    }
                }
            ...
            _proto._init = function _init() {
                ...
                if (this._config.loginRegisterAutoHeight === true) {
                    ...
                    Number.isInteger(this._config.loginRegisterAutoHeight)
                ) {
                    setInterval(
                        this.fixLoginRegisterHeight,
    ...
    var PushMenu = (function($) {
        ...
        var PushMenu = /*#__PURE__*/ (function() {
                ...
                if (this._options.autoCollapseSize) {
                    if ($(window).width() <= this._options.autoCollapseSize) {
                        ...
                        if ($(Selector.BODY).hasClass(ClassName.OPEN)) {
                            ...
                            $(Selector.BODY).hasClass(ClassName.CLOSED)
                        ) {
                            this.expand();
                        }
                    }
            ...
            _proto.remember = function remember() {
                if (this._options.enableRemember) {
                    var toggleState = localStorage.getItem(
                        "remember" + EVENT_KEY
                    );
            ...
            _proto.collapse = function collapse(treeviewMenu, parentLi) {
                ...
                treeviewMenu
                    ...
                    .slideUp(this._config.animationSpeed, function() {
                        ...
                        treeviewMenu
                            .find(
                                Selector.OPEN + " > " + Selector.TREEVIEW_MENU
                            )
                            .slideUp();
                        treeviewMenu
                            .find(Selector.OPEN)
    ...
    var Toasts = (function($) {
        ...
        var Toasts = /*#__PURE__*/ (function() {
            ...
            Toasts._jQueryInterface = function _jQueryInterface(
                option,
                config
            ) {
                return this.each(function() {
