...
use App\Model\Common\ServiceType as ThisModel;
...
{
	protected $view = 'common.service_types';
	protected $route = 'ServiceType';
    ...
    public function exportExcel() {
        return (new FastExcel(ThisModel::all()))->download('danh_sach_loai_dich_vu.xlsx', function ($object) {
            return [
                'ID' => $object->id,
                'Tên' => $object->name,
