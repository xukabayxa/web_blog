...
use App\Model\Common\Unit as ThisModel;
...
{
	protected $view = 'common.units';
	protected $route = 'Unit';
    ...
    public function exportExcel() {
        return (new FastExcel(ThisModel::all()))->download('don_vi_tinh.xlsx', function ($object) {
            return [
                'ID' => $object->id,
                'Tên' => $object->name,
