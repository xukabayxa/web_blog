...
use App\Model\Common\VehicleCategory as ThisModel;
...
{
	protected $view = 'common.vehicles.categories';
	protected $route = 'VehicleCategory';
    ...
    public function exportExcel() {
        return (new FastExcel(ThisModel::all()))->download('danh_sach_dong_xe.xlsx', function ($object) {
            return [
                'ID' => $object->id,
                'Tên' => $object->name,
    ...
    public function exportPDF() {
        ...
        return $pdf->download('danh_sach_dong_xe.pdf');
    }
}
