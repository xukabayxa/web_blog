...
use App\Model\Admin\ProjectCategory as ThisModel;
...
{
    protected $view = 'admin.project_categories';
    protected $route = 'project_categories';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($request->image) {
                FileHelper::uploadFile($request->image, 'project_categories', $object->id, ThisModel::class, 'image',1);
            }
            DB::commit();
            $json->success = true;
