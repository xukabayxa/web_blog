...
use App\Model\G7\ReceiptVoucherType as ThisModel;
...
{
	protected $view = 'g7.funds.receipt_voucher_types';
	protected $route = 'ReceiptVoucherType';
	...
	public function store(Request $request)
	{
		$validate = Validator::make(
			$request->all(),
			[
				'name' => 'required|unique:receipt_voucher_types,name',
	...
	public function update(Request $request, $id)
	{
		$validate = Validator::make(
			$request->all(),
			[
				'name' => 'required|unique:receipt_voucher_types,name,'.$id,
				'status' => 'required|in:0,1',
				'note' => 'max:255',
			]
		);
