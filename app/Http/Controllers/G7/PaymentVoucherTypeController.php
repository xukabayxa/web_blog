...
use App\Model\G7\PaymentVoucherType as ThisModel;
...
class PaymentVoucherTypeController extends Controller
{
	protected $view = 'g7.funds.payment_voucher_types';
	protected $route = 'PaymentVoucherType';
	...
	public function store(Request $request)
	{
		$validate = Validator::make(
			$request->all(),
			[
				'name' => 'required|unique:payment_voucher_types,name',
	...
	public function update(Request $request, $id)
	{
		$validate = Validator::make(
			$request->all(),
			[
				'name' => 'required|unique:payment_voucher_types,name,'.$id,
				'status' => 'required|in:0,1',
				'note' => 'max:255',
			]
		);
