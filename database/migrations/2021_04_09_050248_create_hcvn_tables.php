...
class CreateHcvnTables extends Migration
{
    ...
    public function up()
    {
        ...
        if (empty($tableNames)) {
            throw new \Exception('Error: config/hanhchinhvn.php not found and defaults could not be merged. Please publish the package configuration before proceeding.');
        }
