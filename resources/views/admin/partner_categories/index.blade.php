...
@endsection
@section('buttons')
<a href="{{ route('partner-category.create') }}" class="btn btn-outline-success btn-sm" class="btn btn-info"><i class="fa fa-plus"></i> Thêm mới</a>
@endsection
@section('content')
<div ng-cloak>
                    ...
                    $html.= '<li class="dd-item dd3-item" data-id="'.$value['id'].'">
                      ...
                      <div class="dd3-content"> <span id="label_show'.$value['id'].'">'.$value['name'].'</span>
                        <span class="span-right">
                          ...
                          <a class="edit-button" href="'. route('partner-category.edit',$value['id']) .'" id="'.$value['id'].'" label="'.$value['name'].'"><i class="fas fa-pencil-alt"></i></a>
                          <a class="del-button confirm" href="'. route('partner-category.delete',$value['id']) .'" id="'.$value['id'].'"><i class="fa fa-trash"></i></a></span>
                      </div>';
...
<script>
  $(document).ready(function(){
    ...
    $('.dd').on('change', function() {
      ...
      $.ajax({
        type: "POST",
        url: baseURL + '/admin/partner-categories/nested-sort',
        data: {dataString},
        cache : false,
        headers: {
