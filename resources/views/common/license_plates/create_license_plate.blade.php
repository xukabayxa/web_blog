        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success btn-cons" ng-click="submit()" ng-disabled="loading.license_plate">
                        <i ng-if="!loading.license_plate" class="fa fa-save"></i>
                        <i ng-if="loading.license_plate" class="fa fa-spin fa-spinner"></i>
                        Lưu
                    </button>
...
<script>
    let createLicensePlateCallback;
    app.controller('CreateLicensePlate', function ($scope, $http) {
        ...
        $scope.submit = function() {
            ...
            var data = $scope.form;
            $scope.loading.license_plate = true;
            $.ajax({
                type: "POST",
                url: url,
                data: data,
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        if (createLicensePlateCallback) createLicensePlateCallback(response.data);
                    } else {
                ...
                complete: function() {
                    $scope.loading.license_plate = false;
                    $scope.$applyAsync();
                },
            });
        }
